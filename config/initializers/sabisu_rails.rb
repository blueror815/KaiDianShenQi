...
SabisuRails.setup do |config|
  ...
  config.base_api_uri = 'api.caowu.dev'
  config.api_headers = { "Accept" => "application/vnd.caowu.v1" }
  config.resources = ['retailers']
  config.default_resource = 'retailers'
